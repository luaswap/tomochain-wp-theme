...
/**
 * Create field Enterprise category
 */

if ( ! function_exists( 'tomochain_enterprise_cat_param' ) ) :
	function tomochain_enterprise_cat_param( $settings, $value ) {
		$categories      = get_categories( array(
	...
	vc_add_shortcode_param( 'enter_cat', 'tomochain_enterprise_cat_param');
