...
(
    function ($) {
        tomochain.event_view = function () {
            var $event_item = $('.archive-page-wrap article');
            $event_item.on('click',function(e){
                ...
                $.ajax({
                    ...
                    beforeSend: function(){
                        // $_this.parents('.archive-page-wrap').find('article.col-md-6').remove();
                    },
                    success: function(data){
                        var selector = $_this.parents('.archive-page-wrap').find('article:nth-last-child(1)');
