...
if ( ! function_exists( 'tomochain_setup' ) ) :
	...
	function tomochain_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'tomochain' ),
		) );
...
function tomochain_scripts() {
	...
	wp_enqueue_script( 'tomochain-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'tomochain-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );
