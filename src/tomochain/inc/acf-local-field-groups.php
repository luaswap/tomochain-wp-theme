...
if( function_exists('acf_add_local_field_group') ) {
    ...
    acf_add_local_field_group(array (
        ...
        'fields' => array (
            ...
            array (
                'key' => 'field_5b482d1b5ahe9',
                'label' => 'Bounty URL',
                'name' => 'bounty_url',
                'type' => 'url',
                'instructions' => 'Redirect to Bounty Page',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array (
                    'width' => '',
            ...
            array (
                'key' => 'field_5c22044ck356b',
                'label' => 'VietNam Form (Enter ID)',
                'name' => 'vn_form',
                'type' => 'number',
                'instructions' => '',
                'required' => 0,
            ...
            array (
                'key' => 'field_5c32004ck151b',
                'label' => 'Japan Form (Enter ID)',
                'name' => 'jp_form',
                'type' => 'number',
                'instructions' => '',
                'required' => 0,
            ...
            array (
                'key' => 'field_5c42094ck183b',
                'label' => 'China Form (Enter ID)',
                'name' => 'cn_form',
                'type' => 'number',
                'instructions' => '',
                'required' => 0,
            ...
            array (
                'key' => 'field_5c42074ck157b',
                'label' => 'Korea Form (Enter ID)',
                'name' => 'kr_form',
                'type' => 'number',
                'instructions' => '',
                'required' => 0,
            ...
            array (
                'key' => 'field_5c52094ck127b',
                'label' => 'Spain Form (Enter ID)',
                'name' => 'es_form',
                'type' => 'number',
                'instructions' => '',
                'required' => 0,
            ...
            array (
                'key' => 'field_5c2db5612ad58',
                'label' => 'Excerpt Length',
                'name' => 'enter_excerpt_length',
                'type' => 'number',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
   ...
   /* Bouty Option */
    ...
    /* Enterprise Option */
    acf_add_local_field_group(array (
        'key' => 'group_5b76356a2359f',
        'title' => 'Enterprise Option',
        'fields' => array (
            array (
                'key' => 'field_5b862d6b83h56',
                'label' => 'Custom URL',
                'name' => 'enter_custom_url',
                'type' => 'url',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array (
                'key' => 'field_5b85308b8rf46',
                'label' => '',
                'name' => 'enter_open_in_new_tab',
                'type' => 'true_false',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
